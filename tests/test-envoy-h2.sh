#!/bin/sh
# Ingress --HTTP/1.1--> Envoy --HTTP/2--> java-demo
...
oha -c 100 -z 10m -m POST -d '{}' -H "Content-Type: application/json" -H "Host: envoy" "http://$LOAD_BALANCER_IP/java-demo/sleep?min=50&max=200&h2"
